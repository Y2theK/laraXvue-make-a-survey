<template>
  ...
  >
    <img :src="survey.image_url" alt="" class="w-full object-cover h-48" />
    ...
    <div class="flex justify-between items-center mt-3">
      ...
      <div class="flex justify-center items-center">
        ...
        <button
          ...
          class="h-8 w-8 flex items-center justify-center border border-transparent text-sm rounded-full text-red-500 focus:ring-offset-2 focus:ring-red-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
